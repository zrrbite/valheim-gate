...
Written 2026-08-23, at `0.221.12-run.alpha40`. This is the "pick it back up
...
- Branch **`feature/run-mode`**, 94 commits ahead of `main`. **Not merged**,
  deliberately — the mode is still being tuned in play.
- Latest tag **`0.221.12-run.alpha40`**, pushed. The Mac has it deployed.
...
## What the mode is, as of alpha40
