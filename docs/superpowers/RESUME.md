...
Written 2026-08-23, last updated 2026-09-20 at `1.0.15-run.2026-09-20m`. This is the "pick it back up
...
- Branch **`feature/run-mode`**, not merged, deliberately — the mode is still
  being tuned in play.
- Latest tag **`1.0.15-run.2026-09-20m`**; builds are date-based since 2026-08-31
