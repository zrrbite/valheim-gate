...
Written 2026-08-23, at `0.221.12-run.alpha39`. This is the "pick it back up
...
- Branch **`feature/run-mode`**, 93 commits ahead of `main`. **Not merged**,
  deliberately — the mode is still being tuned in play.
- Latest tag **`0.221.12-run.alpha39`**, pushed. The Mac has it deployed.
...
## What the mode is, as of alpha39
